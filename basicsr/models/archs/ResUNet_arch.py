...
class ResUNet(nn.Module):
    def __init__(self,
        ...
        # fine-level conv
        self.out_conv = nn.Conv2d(out_ch, window_size*window_size, 1, 1)
    ...
    def forward(self, x):
        ...
        B, _, H, W = x_out.shape
        x_kernel = x_out.reshape(B, self.window_size, self.window_size, H, W)
        x_kernel = x_kernel.permute(0, 3, 4, 1, 2)
