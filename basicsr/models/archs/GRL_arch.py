...
from basicsr.models.archs.GRL.common import Upsample, UpsampleOneStep
from basicsr.models.archs.GRL.common.mixed_attn_block_efficient import (
    _get_stripe_info,
    EfficientMixAttnTransformerBlock,
)
from basicsr.models.archs.GRL.common.ops import (
    bchw_to_blc,
    blc_to_bchw,
    calculate_mask,
    calculate_mask_all,
...
from basicsr.models.archs.GRL.common.swin_v1_block import (
    build_last_conv,
)
...
if __name__ == "__main__":
    ...
    model = GRL(
        ...
        num_heads_stripe=[3, 3, 3, 3, 3, 3, 3], 
        window_size=8, # 12 
        stripe_size=[64, 64], #[48, 96], # ['64', '128']
        stripe_groups=[None, None], 
        stripe_shift=True, 
        mlp_ratio=2, 
        qkv_proj_type='linear', 
